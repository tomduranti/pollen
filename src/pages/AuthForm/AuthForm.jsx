    ...
    return (
        <section className='flex flex-col gap-5 md:mx-auto md:max-w-sm md:w-full md:border md:border-solid md:rounded-2xl md:border-transparent md:px-8 md:py-5 md:shadow-[0px_7px_29px_0px_rgba(100,100,111,0.2)]'>
            ...
            <form noValidate className='flex flex-col gap-3'
                ...
                {authMode === 'signin'
                    ? <div className='text-[0.813rem] text-(--color-text-secondary) font-normal'>Don't have an account? <NavLink to='/signup'  tabIndex={0}className='safari font-bold'>Sign up</NavLink></div>
                    : <div className='text-[0.813rem] text-(--color-text-secondary) font-normal'>Already have an account? <NavLink to='/signin' tabIndex={0} className='safari font-bold'>Sign in</NavLink></div>
                }
